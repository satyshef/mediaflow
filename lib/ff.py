...
def concatenate_videos(input_files, output_file, duration):
    #concat_file = tempfile.gettempdir() + '/concat.txt'
    concat_file = '/tmp/concat.txt'
    print("FFFFFF", output_file)
...
def overlay_audio(input_video, input_audio, output_video):
    """
    ...
    try:
        ...
        if input_video == output_video:
            os.rename(output_file_path, output_video)
